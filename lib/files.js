...
function createComponentIndex(compName) {
	return `export default from'./${compName}';`;
}
...
/**
 * Creates a barebones test skeleton for a react component
 * 
 * @param  {string} compName - The name that was input.
 * @return {string}          - A string of the component's tests contents.
 */
function createComponentTest(compName) {
	return `import React from 'react';
